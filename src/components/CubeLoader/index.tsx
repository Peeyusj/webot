export default function CubeLoader() {
  return (
    <div className="flex items-center justify-center h-[200px] w-full mt-4 mb-4">
      <style>{`
        .loader-container {
          transform: scale(0.6); /* Scaled to fit sidebar nicely */
        }
        ...
        .loader:before, .loader:after {
          ...
          right: 32%;
          bottom: -11px;
          background: #ffffff; /* MATCHES YOUR APP BG FOR SEAMLESS MASKING */
